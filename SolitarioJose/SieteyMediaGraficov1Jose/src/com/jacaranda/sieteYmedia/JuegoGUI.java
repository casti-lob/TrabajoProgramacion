...
public class JuegoGUI implements ActionListener {
	...
	public JuegoGUI() throws CartaException  {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (bx == mePlanto) {
			...
			do {
				...
				} catch (BarajaException | CartaException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
			
				ImageIcon imageIcon = new ImageIcon(System.getProperty("user.dir") + "/img/"+ carta.getPalo().toLowerCase() + "s_" + carta.getNumber() + "s.jpg");
